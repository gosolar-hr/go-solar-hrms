...
// ─────────────────────────────────────────────────────────
export function calculatePF(employee, earnedGross = null) {
  ...
  if (earnedGross !== null && totalCTC > 0) {
    const earnedHRA = (Number(employee.hra || 0) / totalCTC) * earnedGross
    pfWage = Math.max(0, earnedGross - earnedHRA)
  } else {
